...
public class CommonLoginController {
    ...
    public AjaxResult getRouters() {
                ...
                // 产品管理
                Menu m2 = new Menu("Product", "/product", false, "noRedirect", "Layout" , true , new Menu.Meta("产品管理", "redis", false, null),
                        List.of(
                                new Menu("项目管理", "smart/ocr/project/list", false, false, "projecttList", new Menu.Meta("项目管理", "number", false, null)),
                                new Menu("监控管理", "smart/ocr/monitormanage/list", false, false, "monitorManagelist",  new Menu.Meta("监控管理", "redis", false, null)),
                                new Menu("开通服务", "smart/ocr/openservice/types", false, false, "openServicelist",  new Menu.Meta("开通服务", "search", false, null))
                        )) ;
